...
import { PARAM_RESOURCE_TYPE, rssChoicesOption } from "../../commandOptions";
  ...
  constructor(db: D1Database) {
    super(
      new CommandGroupBuilder("rss", "Store resources held.").addSubcommands(
        new SubcommandOption("set", "Set the number of an RSS type currently possessed.").addStringOption(
          rssChoicesOption
        )
